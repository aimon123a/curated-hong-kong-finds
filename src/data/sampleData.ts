...
export const selectors: Selector[] = [
  {
    ...
    title: "身體護理 × 生活品格 SELECTor",
    specialty: "身體暗瘡控制、日系手信選物",
    bio: "擁有超過29年生暗瘡經驗，專注於身體肌膚護理研究，對暗瘡成因及護理有深入了解。近年亦把同樣的挑剔用在生活品格上：由日本白蘭地蛋糕到熟成甜點，親身試食、記錄每日風味變化，只推薦自己會回購的選擇。相信健康自信的肌膚，與一份講究的日常，同樣值得擁有。",
    imageUrl: ansonImage,
    articleCount: 2,
    expertise: ["身體暗瘡", "背部護理", "去角質", "身體乳液", "日本手信", "熟成甜點", "送禮選物"],
    socialLinks: {
      instagram: "#",
    },
  },
