...
const Header = () => {
  ...
  return (
    <header className={`sticky top-0 z-50 border-b transition-colors ${isBrandyCake ? "bc-header bg-transparent border-black/60" : "bg-card/95 backdrop-blur-sm border-border"}`}>
